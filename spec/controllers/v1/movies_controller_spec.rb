...
RSpec.describe V1::MoviesController, type: :controller do
  ...
  # V1::Movie. As you add validations to V1::Movie, be sure to
  ...
  # V1::MoviesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested movie" do
        movie = V1::Movie.create! valid_attributes
